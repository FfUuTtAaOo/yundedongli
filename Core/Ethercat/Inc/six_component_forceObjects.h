...
#endif
/******************************************************************************
*                    Object 0x1600 : DO Outputs process data mapping
******************************************************************************/
/**
* \addtogroup 0x1600 0x1600 | DO Outputs process data mapping
* @{
* \brief Object 0x1600 (DO Outputs process data mapping) definition
*/
#ifdef _OBJD_
/**
...
*/
OBJCONST UCHAR OBJMEM aName0x1600[] = "DO Outputs process data mapping\000"
"SubIndex 001\000\377";
#endif //#ifdef _OBJD_

#ifndef _SIX_COMPONENT_FORCE_OBJECTS_H_
/**
...
TOBJ1600;
#endif //#ifndef _SIX_COMPONENT_FORCE_OBJECTS_H_

/**
* \brief Object variable
*/
PROTO TOBJ1600 DOOutputsProcessDataMapping0x1600
#if defined(_SIX_COMPONENT_FORCE_) && (_SIX_COMPONENT_FORCE_ == 1)
={1,0x70000120}
#endif
;
...
* \brief Object/Entry names
*/
OBJCONST UCHAR OBJMEM aName0x1A00[] = "DI Inputs process data mapping\000"
"SubIndex 001\000"
"SubIndex 002\000"
"SubIndex 003\000"
"SubIndex 004\000"
...
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex1 - Fx */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex2 - Fy */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex3 - Fz */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex4 - Tx */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }, /* Subindex5 - Ty */
{ DEFTYPE_REAL32 , 0x20 , ACCESS_READ | OBJACCESS_TXPDOMAPPING }}; /* Subindex6 - Tz */
...
typedef struct OBJ_STRUCT_PACKED_START {
UINT16 u16SubIndex0;
REAL32 Fx; /* Subindex1 - Fx */
REAL32 Fy; /* Subindex2 - Fy */
REAL32 Fz; /* Subindex3 - Fz */
REAL32 Tx; /* Subindex4 - Tx */
REAL32 Ty; /* Subindex5 - Ty */
REAL32 Tz; /* Subindex6 - Tz */
} OBJ_STRUCT_PACKED_END
TOBJ6000;
#endif //#ifndef _SIX_COMPONENT_FORCE_OBJECTS_H_
...
{ DEFTYPE_UNSIGNED8 , 0x8 , ACCESS_READ },
{ DEFTYPE_UNSIGNED32 , 0x20 , ACCESS_READ | OBJACCESS_RXPDOMAPPING }}; /* Subindex1 - ret */
...
/* Object 0x1600 */
{NULL , NULL ,  0x1600 , {DEFTYPE_PDOMAPPING , 1 | (OBJCODE_REC << 8)} , asEntryDesc0x1600 , aName0x1600 , &DOOutputsProcessDataMapping0x1600 , NULL , NULL , 0x0000 },
/* Object 0x1A00 */
{NULL , NULL ,  0x1A00 , {DEFTYPE_PDOMAPPING , 6 | (OBJCODE_REC << 8)} , asEntryDesc0x1A00 , aName0x1A00 , &DIInputsProcessDataMapping0x1A00 , NULL , NULL , 0x0000 },
/* Object 0x1C12 */
{NULL , NULL ,  0x1C12 , {DEFTYPE_UNSIGNED16 , 1 | (OBJCODE_ARR << 8)} , asEntryDesc0x1C12 , aName0x1C12 , &sRxPDOassign , NULL , NULL , 0x0000 },
/* Object 0x1C13 */
{NULL , NULL ,  0x1C13 , {DEFTYPE_UNSIGNED16 , 1 | (OBJCODE_ARR << 8)} , asEntryDesc0x1C13 , aName0x1C13 , &sTxPDOassign , NULL , NULL , 0x0000 },
/* Object 0x6000 */
{NULL , NULL ,  0x6000 , {DEFTYPE_RECORD , 6 | (OBJCODE_REC << 8)} , asEntryDesc0x6000 , aName0x6000 , &DIInputs0x6000 , NULL , NULL , 0x0000 },
/* Object 0x7000 */
{NULL , NULL ,  0x7000 , {DEFTYPE_RECORD , 1 | (OBJCODE_REC << 8)} , asEntryDesc0x7000 , aName0x7000 , &DOOutputs0x7000 , NULL , NULL , 0x0000 },
/* Object 0xF000 */
...
/** @}*/
#define _SIX_COMPONENT_FORCE_OBJECTS_H_
