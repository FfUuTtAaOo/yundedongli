...
floatuint_t tmp[12] = { {1.000000}, {2.000000}, {3.000000}, {4.000000}, {5.000000}, {6.000000}, {0.000000}, {0.000000}, {0.000000}, {0.000000}, {0.000000}, {0.000000} };
/////////////////////////////////////////////////////////////////////////////////////////
/**
...
void APPL_InputMapping(UINT16* pData)
{
    ...
    for (j = 0; j < sTxPDOassign.u16SubIndex0; j++) {
		...
		/* TxPDO 1 */
		case 0x1A00:
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[0]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[1]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[2]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[3]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[4]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[5]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[6]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[7]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[8]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[9]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[10]);
			*pTmpData++ = SWAPWORD(((UINT16 *) &tmp)[11]);
			break;
		}
    }
}
